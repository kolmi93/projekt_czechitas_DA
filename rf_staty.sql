...
// vytvoříme nové sloupce jako FLOAT
...
// vytvoří sloupec, kde zobrazí pouze majoritní náboženství
...
SELECT DISTINCT
    ...
    density.Entity as ENTITY, 
     CASE
        WHEN primorske.state is null THEN 1 // to znamená, že je přímořský
        ELSE 0 // nemá moře
     END as SEA_FLAG,
